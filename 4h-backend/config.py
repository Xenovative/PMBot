...
class BotConfig(BaseModel):
    ...
    min_time_remaining_seconds: int = _int("MIN_TIME_REMAINING_SECONDS", 1800)
    ...
    crypto_symbols: List[str] = _str("CRYPTO_SYMBOLS", "btc,eth,sol,xrp").split(",")
    ...
    bargain_open_time_window_seconds: int = _int("BARGAIN_OPEN_TIME_WINDOW_SECONDS", 10800)
