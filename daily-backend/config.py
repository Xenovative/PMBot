...
class BotConfig(BaseModel):
    ...
    min_time_remaining_seconds: int = _int("MIN_TIME_REMAINING_SECONDS", 3600)
    ...
    bargain_open_time_window_seconds: int = _int("BARGAIN_OPEN_TIME_WINDOW_SECONDS", 43200)
    # Escalation window now in minutes (was hours)
    bargain_pair_escalation_minutes: int = _int("BARGAIN_PAIR_ESCALATION_MINUTES", 180)
