...
DB_PATH = os.path.join(DB_DIR, "pmbot_m5_live.db")  # default, overridden by init_db()
...
def init_db(dry_run: bool = True):
    ...
    global DB_PATH
    db_name = "pmbot_m5_paper.db" if dry_run else "pmbot_m5_live.db"
    ...
    conn.executescript("""
        CREATE TABLE IF NOT EXISTS trades (
            ...
            trade_type  TEXT    NOT NULL DEFAULT 'arbitrage',  -- arbitrage | bargain_open | bargain_pair | bargain_stop
            side        TEXT,                                   -- UP | DOWN | BOTH
