...
class BotConfig(BaseModel):
    ...
    max_time_remaining_seconds: int = int(os.getenv("MAX_TIME_REMAINING_SECONDS", "1200"))
    max_trades_per_market: int = int(os.getenv("MAX_TRADES_PER_MARKET", "3"))
    trade_cooldown_seconds: int = int(os.getenv("TRADE_COOLDOWN_SECONDS", "15"))
    max_position_imbalance: int = int(os.getenv("MAX_POSITION_IMBALANCE", "3"))
    min_liquidity: float = float(os.getenv("MIN_LIQUIDITY", "20"))
    ...
    bargain_pair_escalation_minutes: int = int(os.getenv("BARGAIN_PAIR_ESCALATION_MINUTES", "60"))
