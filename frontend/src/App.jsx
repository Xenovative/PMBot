      ...
      <header className="border-b border-gray-800 bg-gray-900/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight">Polymarket 套利機器人</h1>
              <p className="text-xs text-gray-500">15 分鐘加密貨幣市場自動套利</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <ConfigField
                label="最少剩餘時間 (秒)"
                type="number"
                value={configForm.min_time_remaining_seconds ?? 120}
              ...
              <ConfigField
                label="交易冷卻期 (秒)"
                type="number"
                value={configForm.trade_cooldown_seconds ?? 60}
                onChange={(v) => setConfigForm({ ...configForm, trade_cooldown_seconds: parseInt(v) })}
              />
              <ConfigField
                label="最低流動性"
                type="number"
                value={configForm.min_liquidity ?? 100}
                ...
                <thead>
                  <tr className="text-xs text-gray-500 border-b border-gray-800">
                    ...
                    <th className="text-right py-2 pl-3 font-medium">
                      <span className="flex items-center justify-end gap-1"><Zap className="w-3 h-3 text-violet-400" />價差</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-1.5 ml-2">
                        ...
                        <span className={`text-xs font-mono ${
                          m.time_remaining_seconds < 120 ? 'text-red-400' : 'text-gray-400'
                        }`}>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-400">
            <div>
              <h4 className="text-white font-medium mb-2">什麼是套利？</h4>
              <p className="mb-2">
                當 UP 價格 + DOWN 價格 &lt; $1.00 時，同時買入兩邊就能穩賺！
              </p>
            ...
            <div>
              <h4 className="text-white font-medium mb-2">風險控制機制</h4>
              <ul className="space-y-1.5 text-xs">
                <li className="flex items-start gap-2">
                  <Clock className="w-3 h-3 mt-0.5 text-violet-400 shrink-0" />
                  <span>剩餘時間檢查 — 市場快關閉時不交易</span>
                </li>
                <li className="flex items-start gap-2">
                  <Shield className="w-3 h-3 mt-0.5 text-violet-400 shrink-0" />
                  <span>交易次數限制 — 每個市場最多交易 N 次</span>
                </li>
                <li className="flex items-start gap-2">
                  <BarChart3 className="w-3 h-3 mt-0.5 text-violet-400 shrink-0" />
                  <span>流動性檢查 — 確保市場有足夠深度</span>
                </li>
                <li className="flex items-start gap-2">
                  <DollarSign className="w-3 h-3 mt-0.5 text-violet-400 shrink-0" />
                  <span>價格合理性 — 避免異常價格導致虧損</span>
                </li>
                <li className="flex items-start gap-2">
                  <RefreshCw className="w-3 h-3 mt-0.5 text-violet-400 shrink-0" />
                  <span>交易冷卻期 — 每次交易後等待避免頻繁操作</span>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-violet-500 transition-colors"
        />
        {suffix}
      </div>
