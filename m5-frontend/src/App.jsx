            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 lg:col-span-3 flex items-center justify-between bg-black/30 border border-neon-cyan/20 rounded-lg p-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500">掃描頻率依 scan_interval_seconds 固定，僅記錄最近價格速度；可調整取樣點數。</p>
                </div>
                <button
        ...
        <div className="fixed inset-0 z-[55] flex items-center justify-center px-4">
          ...
          <div className="relative z-10 w-full max-w-lg cyber-panel p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <BreakdownStat label="淨損益" value={analyticsOverview.total_profit} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="總獲利" value={analyticsOverview.gross_profit ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="總虧損" value={analyticsOverview.gross_loss ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="平均獲利" value={analyticsOverview.avg_profit ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="今日淨損益" value={analyticsOverview.today_profit ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="今日總獲利" value={analyticsOverview.today_gross_profit ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="今日總虧損" value={analyticsOverview.today_gross_loss ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="最佳交易" value={analyticsOverview.best_trade ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
              <BreakdownStat label="最差交易" value={analyticsOverview.worst_trade ?? 0} positiveColor="text-neon-green" negativeColor="text-neon-pink" />
            </div>
          </div>
        </div>
      )}
